...
public class Basketball extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edit1.getText().toString().isEmpty() || edit2.getText().toString().isEmpty()
                    ...
                    Toast.makeText(Basketball.this, "Ensure you fill all answers", Toast.LENGTH_SHORT).show();
                }else {
                    doIt();
                }
            }
    ...
    private void checkFame() {
        ...
        progressBar.setVisibility(View.VISIBLE);
        Call<FameModel> call = RetrofitClient.getInstance(Basketball.this)
                .getApiConnector()
                .getF(us);
    ...
    private void collect() {
        String us = sharedPreferencesConfig.readClientsPhone();
        String key = Integer.toString(8);
        progressBar.setVisibility(View.VISIBLE);
        Call<MessagesModel> call = RetrofitClient.getInstance(Basketball.this)
                .getApiConnector()
                .up(us,key);
