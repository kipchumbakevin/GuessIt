...
import com.guess.guessit.Candy;
...
public class Actor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = 0;
        pass = Integer.parseInt(getIntent().getExtras().getString("ACTOR"));
    ...
    private void correct() {
        ...
        Call<MessagesModel> call = RetrofitClient.getInstance(Actor.this)
                .getApiConnector()
                .earnG(us,key);
        call.enqueue(new Callback<MessagesModel>() {
            ...
            public void onResponse(Call<MessagesModel> call, Response<MessagesModel> response) {
                ...
                if (response.code()==201) {
                    ...
                    Toast.makeText(Actor.this, "Server error. Retry ", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<MessagesModel> call, Throwable t) {
                ena();
                progressBar.setVisibility(View.GONE);
                Toast.makeText(Actor.this, "Network error", Toast.LENGTH_SHORT).show();
            }
    ...
    private void hooray() {
        AlertDialog.Builder ale = new AlertDialog.Builder(Actor.this);
        ale.setTitle("GREAT!")
