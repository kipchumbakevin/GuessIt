...
public class MaleMusic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_music);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edit1.getText().toString().isEmpty() || edit2.getText().toString().isEmpty()
                    ...
                    Toast.makeText(MaleMusic.this, "Ensure you fill all answers", Toast.LENGTH_SHORT).show();
                }else {
                    doIt();
                }
            }
    ...
    private void checkFame() {
        ...
        Call<FameModel> call = RetrofitClient.getInstance(MaleMusic.this)
                .getApiConnector()
                .getF(us);
        call.enqueue(new Callback<FameModel>() {
            ...
            public void onResponse(Call<FameModel> call, Response<FameModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getMaleMusic() == 1){
                       already();
    ...
    private void collect() {
        ...
        progressBar.setVisibility(View.VISIBLE);
        Call<MessagesModel> call = RetrofitClient.getInstance(MaleMusic.this)
                .getApiConnector()
                .up(us,key);
