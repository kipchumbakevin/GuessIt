...
public class ExConvict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex_convict);
        back = 0;
        pass = Integer.parseInt(getIntent().getExtras().getString("CONVICT"));
    ...
    private void correct() {
        ...
        Call<MessagesModel> call = RetrofitClient.getInstance(ExConvict.this)
                .getApiConnector()
                .earnG(us,key);
