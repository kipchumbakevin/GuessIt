...
public class Presidents extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edit1.getText().toString().isEmpty() || edit2.getText().toString().isEmpty()
                    ...
                    Toast.makeText(Presidents.this, "Ensure you fill all answers", Toast.LENGTH_SHORT).show();
                }else {
                    doIt();
                }
            }
    ...
    private void checkFame() {
        ...
        Call<FameModel> call = RetrofitClient.getInstance(Presidents.this)
                .getApiConnector()
                .getF(us);
        call.enqueue(new Callback<FameModel>() {
            ...
            public void onResponse(Call<FameModel> call, Response<FameModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getPresident() == 1){
                       already();
    ...
    private void collect() {
        String us = sharedPreferencesConfig.readClientsPhone();
        String key = Integer.toString(5);
        progressBar.setVisibility(View.VISIBLE);
        Call<MessagesModel> call = RetrofitClient.getInstance(Presidents.this)
                .getApiConnector()
                .up(us,key);
