...
public class Jobless extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jobless);
        back = 0;
        pass = Integer.parseInt(getIntent().getExtras().getString("JOBLESS"));
    ...
    private void correct() {
        ...
        Call<MessagesModel> call = RetrofitClient.getInstance(Jobless.this)
                .getApiConnector()
                .earnG(us,key);
