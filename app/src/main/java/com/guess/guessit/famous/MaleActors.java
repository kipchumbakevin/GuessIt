...
public class MaleActors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_male_actors);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edit1.getText().toString().isEmpty() || edit2.getText().toString().isEmpty()
                    ...
                    Toast.makeText(MaleActors.this, "Ensure you fill all answers", Toast.LENGTH_SHORT).show();
                }else {
                    doIt();
                }
            }
    ...
    private void checkFame() {
        ...
        Call<FameModel> call = RetrofitClient.getInstance(MaleActors.this)
                .getApiConnector()
                .getF(us);
        call.enqueue(new Callback<FameModel>() {
            ...
            public void onResponse(Call<FameModel> call, Response<FameModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getMaleActor() == 1){
                        already();
    ...
    private void collect() {
        String us = sharedPreferencesConfig.readClientsPhone();
        String key = Integer.toString(4);
        progressBar.setVisibility(View.VISIBLE);
        Call<MessagesModel> call = RetrofitClient.getInstance(MaleActors.this)
                .getApiConnector()
                .up(us,key);
