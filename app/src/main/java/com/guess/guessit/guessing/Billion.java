...
public class Billion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billion);
        back = 0;
        pass = Integer.parseInt(getIntent().getExtras().getString("BILLION"));
    ...
    private void correct() {
        ...
        Call<MessagesModel> call = RetrofitClient.getInstance(Billion.this)
                .getApiConnector()
                .earnG(us,key);
