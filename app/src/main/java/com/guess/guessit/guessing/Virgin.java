...
public class Virgin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_virgin);
        back = 0;
        pass = Integer.parseInt(getIntent().getExtras().getString("VIRGIN"));
    ...
    private void correct() {
        ...
        Call<MessagesModel> call = RetrofitClient.getInstance(Virgin.this)
                .getApiConnector()
                .earnG(us,key);
